          ...
          <div class="col-md-7 col-md-8">
            ...
            <div class="row g-3">
              <div class="col-sm-6">
                ...
                />
                {errors.firstName && (
                  <div class="text-danger">Valid first name is required.</div>
                )}
              </div>
              <div class="col-sm-6">
                ...
                />
                {errors.lastName && (
                  <div class="text-danger">Valid last name is required.</div>
                )}
              </div>
              <div class="col-12">
              ...
              <div class="col-12">
                ...
                />
                {errors.landmark && (
                  <div class="text-danger">Please enter a landmark</div>
                )}
              </div>
              <div class="col-md-5">
                ...
                {errors.country && (
                  <div class="text-danger">Please select a valid country.</div>
                )}
              </div>
              <div class="col-md-4">
                ...
                {errors.state && (
                  <div class="text-danger">Please provide a valid state.</div>
                )}
              </div>
              <div class="col-md-3">
                ...
                />
                {errors.zip && (
                  <div class="text-danger">Zip code required.</div>
                )}
              </div>
            </div>
            <hr class="mb-4" />
